...
public class AdjacencyListGraph<T> {
    ...
    public Map<T, Integer> shortestPath(T startVertex, T endVertex) {
        Map<T, Integer> distances = new HashMap<>();
        Map<T, T> shortestDistancePath = new HashMap<>();
        ...
        shortestDistancePath.put(startVertex, startVertex);
        ...
        while (!queue.isEmpty()) {
            ...
            for (Map.Entry<T, Integer> neighborEntry : adjacencyList.get(current).entrySet()) {
                ...
                if (newDist < distances.get(neighbor)) {
                    ...
                    shortestDistancePath.put(neighbor, current);
        ...
        while (curr != startVertex) {
            ...
            curr = shortestDistancePath.get(curr);
        }
        stack.push(startVertex);
