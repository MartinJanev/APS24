...
public class BinarySearchTree<E extends Comparable<E>> {
    ...
    private void insertSmenet(E x, BNode<E> t) {
        if (t == null) {
            return;
        }
    ...
    private boolean deleteSmenet(E x, BNode<E> t) {
        if (t == null) {
            return false;
        }
        boolean vratena;
        ...
        if (x.compareTo(t.info) == 0) {
            //go briseme. Najdi zamena
            BNode<E> lev = findMax(t.left); //max od levo poddrvo
            BNode<E> desen = findMin(t.right);//min od desno poddrvo

            if (lev != null) { //ako postoi -> ja zemame vrednosta, ja stavame na t i go briseme left
                t.info = lev.info;
                vratena = deleteSmenet(lev.info, t.left);
                if (vratena) {
                    t.left = null;
                }
                return false;
            ...
            if (desen != null) { //ako postoi -> ja zemame vrednosta, ja stavame na t i go briseme right
                t.info = desen.info;
                vratena = deleteSmenet(desen.info, t.right);
                if (vratena) {
                    t.right = null;
                }
                return false;
        ...
        if (x.compareTo(t.info) > 0) {
            vratena = deleteSmenet(x, t.right);
            if (vratena) {
                t.right = null;
            }
        }
