...
//        public AdjacencyMatrixGraph<T> toAdjacencyMatrixGraph() {
//            int numVertices = adjacencyList.size();
//            AdjacencyMatrixGraph<T> result = new AdjacencyMatrixGraph<>(numVertices);
//
//            List<T> vertices = new ArrayList<>(adjacencyList.keySet());
//            for (int i = 0; i < vertices.size(); i++) {
//                result.addVertex(i, vertices.get(i));
//            }
//
//            for (int i = 0; i < vertices.size(); i++) {
...
//                    result.addEdge(i, neighborIndex);
//                }
//            }
//
//            return result;
        ...
        public int shortestPath(T startVertex, T endVertex) {
            ...
            while (!queue.isEmpty()) {
                ...
                while (elementsAtLevel > 0) {
                    T vertex = queue.poll();
                    if (Objects.equals(vertex, endVertex))
                        return level;
