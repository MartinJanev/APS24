...
public class InsertOutlier {

    public static void insertStr(SLL<String> list, int L) {
        SLLNode<String> prev = list.getFirst();
        SLLNode<String> curr = prev.succ;
        if (prev.element.length() > L) {
            list.insertBefore("Outlier", prev);
        }
        while (curr != null) {
            if (curr.element.length() > L) {
                list.insertAfter("Outlier", prev);
            }
            prev = curr;
            curr = curr.succ;
    ...
    public static void main(String[] args) {
        ...
        SLL<String> list = new InsertOutlier().new SLL<String>();
