...
public class KomunikaciskaMreza {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < M; i++) {
            ...
            String grad1 = tokens[0];
            String grad2 = tokens[1];
            int price = Integer.parseInt(tokens[2]);

            int index1 = getIndex(graph, grad1, N);
            int index2 = getIndex(graph, grad2, N);
    ...
    private static int getIndex(AdjacencyMatrixGraph<String> graph, String city, int N) {
        for (int i = 0; i < N; i++) {
            if (graph.getVertex(i).equals(city)) {
                return i;
            }
        }
        return -1;
